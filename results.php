        ...
        <div class="container search-results-con">
            ...
            <div class="container post-post">
                <div class="row row-first">
                    ...
                    <div class="col-7">
                        <a href="profile.php?username=<?php echo $key["username"]; ?>"><span
                                class="profile-name"><?php echo $key['username']; ?></span></a><br>
                        <a href="results.php?location=<?php echo $key['location']; ?>"
